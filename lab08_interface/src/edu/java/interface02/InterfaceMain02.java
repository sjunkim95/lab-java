...
//    -> 인터페이스의 [public] static 메서드, [public] default 안에서만 사용하기 위한 목적의 메서드.
...
public class InterfaceMain02 {
    ...
    public static void main(String[] args) {
        // 인터페이스의 [public] static 멤버 사용 방법! -> interface 이름.퍼블릭스태틱파이널변수
        System.out.println(Test.VERSION);
        Test.staticMethod();
        
        System.out.println("-------------");
        
        // 인터페이스의 [public] default 메서드 사용 -> 바디를 가진 멤버를 사용하고 싶으면, 구현하라
