...
// import edu.java.modifier06.PackageClass; 이거는 not visible, package클래스로 만들었기 때문에.
...
// public class의 이름은 java 파일의 이름과 같아야 함! (...).java
// 한 개의 java 파일에서 여러개의 클래스를 정의하는 것은 가능하지만,
// public class는 오직 한 개만 정의할 수 있음.
// 한 개의 java 파일에서 여러개의 클래스를 정의하면, 컴파일 후에는 각각의 클래스 파일들이 생성됨.
